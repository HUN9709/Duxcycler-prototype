...
from PyQt5.QtWidgets import QAbstractItemView, QApplication, QCheckBox, QDialog, QFileDialog, QGridLayout, QGroupBox, QHBoxLayout, QHeaderView, QLabel, QProgressBar, QToolButton, QVBoxLayout, QPushButton, QWidget, QMainWindow, QFrame, QTableWidget, QTableWidgetItem, QTabWidget, QSpinBox, QMessageBox
...
class MainUI(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle("DuxCycler_ProtoTester") # set title
